...
import ResourceCardProduct, {
  ResourceCardProductProps,
} from "./ResourceCardProduct.11ty";

const props: ResourceCardProductProps = {
  items: [
...
test("ResourceCardProduct", () => {
  document.body.innerHTML = ResourceCardProduct(props);
